...
export const AdminPanel: React.FC<AdminPanelProps> = ({
  ...
  const handleUpdateOrderDetails = async (newStatus: OrderStatus) => {
    ...
    // Only include driver fields when actually filled in - Firestore rejects
    // `undefined` field values (this previously broke order status updates
    // whenever the driver name/phone boxes were left empty).
